...
from image_captioning.convert_to_tfrecord import load_image
...
from image_captioning.model import ExpandDims, image_captioning_model
...
def main():
    ...
    parser.add_argument("--model_path", help="Path to the trained model", 
                        default="./image_captioning/checkpoints/final.hdf5")
    ...
    parser.add_argument("--results", help="Path to results file", 
                        default="./image_captioning/captions.json")
